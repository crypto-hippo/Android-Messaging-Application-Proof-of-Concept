...
import com.example.dylan.myapplication.ProfileActivity;

import com.example.dylan.myapplication.R;
...
public class FirebaseMessageHandler extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageBody) {
        ...
        // Dylan:todo test this functionality
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_ONE_SHOT);
        String channelId = getString(R.string.notification_channel_id_1);
